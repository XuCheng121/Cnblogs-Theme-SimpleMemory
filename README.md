...
🍰 基于博皮“SimpleMemor”进行的修改；[页面效果](https://www.cnblogs.com/XuChengNotes/)

🧀 支持响应，尺寸分别为：(1200px,∞px)，(960px,1200px]，(720px,960px]，(0px,720px]

# Docs

> 文档可能有缓存，大家可以尝试强制刷新下(ctrl+f5)
...
**Cnblogs-Theme-SimpleMemory** © [Mr. Xu](https://www.cnblogs.com/XuChengNotes/), Released under the [MIT](./LICENSE) License.<br>

> Blog [@Blog](https://www.cnblogs.com/XuChengNotes/) · GitHub [@GitHub](https://github.com/XuCheng121) · Email 344965327@qq.com
